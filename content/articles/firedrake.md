...
If you are interested to see the current Code, I haven't put up a public git repository at GitHub yet, but you can clone the source from my private git repository; `git://fufara.repositoryhosting.com/fufara/fd.git`. MIT License, as usual.
